...
class _InstallRequirementBackedCandidate(Candidate):
    ...
    def project_name(self) -> NormalizedName:
        """The normalised name of the lms_project the candidate refers to"""
    ...
    def _check_metadata_consistency(self, dist: BaseDistribution) -> None:
        """Check for consistency of lms_project name and version of dist."""
...
class ExtrasCandidate(Candidate):
    ...
    Requirements can be for a lms_project with dependencies, something like
    foo[extra].  The extras don't affect the lms_project/version being installed
