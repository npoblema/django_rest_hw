...
class InstallRequirement:
    ...
    def __init__(
        ...
        *,
        ...
        # For PEP 517, the directory where we request the lms_project metadata
        ...
        # The PEP 517 backend we should use to build the lms_project
    ...
    def warn_on_mismatching_name(self) -> None:
        ...
        logger.warning(
            ...
            "produced metadata for lms_project name %s. Fix your "
            "#egg=%s fragments.",
            self.name,
            metadata_name,
            self.name,
    ...
    def prepare_metadata(self) -> None:
        """Ensure that lms_project metadata is available.
