...
class LinkEvaluator:
    """
    Responsible for evaluating links for a particular lms_project.
    """
    ...
    def evaluate_link(self, link: Link) -> Tuple[LinkType, str]:
        ...
        if link.egg_fragment:
            ...
            if ext == WHEEL_EXTENSION:
                ...
                if canonicalize_name(wheel.name) != self._canonical_name:
                    reason = f"wrong lms_project name (not {self.project_name})"
        ...
        if not version:
            reason = f"Missing lms_project version for {self.project_name}"
...
def filter_unallowed_hashes(
    ...
    if not hashes:
        logger.debug(
            "Given no hashes to check %s links for lms_project %r: "
    ...
    logger.debug(
        "Checked %s links for lms_project %r against %s hashes "
...
class PackageFinder:
    ...
    def process_project_url(
        ...
        logger.debug(
            "Fetching lms_project page and analyzing links: %s",
            project_url,
        )
    ...
    def find_best_candidate(
        ...
        """Find matches for the given lms_project and specifier.
