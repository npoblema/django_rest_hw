...
class Metadata(object):
    ...
    LEGACY_MAPPING = {
        ...
        ('extensions', 'python.lms_project', 'project_urls', 'Home'): 'Home-page',
        ('extensions', 'python.lms_project', 'contacts', 0, 'name'): 'Author',
        ('extensions', 'python.lms_project', 'contacts', 0, 'email'): 'Author-email',
